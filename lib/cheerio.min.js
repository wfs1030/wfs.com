...
var jt = function() {
		...
		return t.nextToken = function() {
			...
			if (this.in_code) {
				...
				if ((e = this._extractUntil(" \n\t\rÂ ()[]{}%*-+~/#,:|.<>=!")).match(/^[-+]?[0-9]+$/)) return "." === this.current() ? (this.forward(), Kt("float", e + "." + this._extract("0123456789"), t, n)) : Kt("int", e, t, n);
...
var go = Ke((function(e, t) {
	Object.defineProperty(t, "__esModule", {
		value: !0
	}), t.default = new Uint16Array("È€aglq\tÉ­\0\0p;ä€¦os;ä€§t;ä€¾t;ä€¼uot;ä€¢".split("").map((function(e) {
		return e.charCodeAt(0)
	})))
}));
qe(go);
	...
	_stateRcdata(e) {
		switch (e) {
			...
			case io.LESS_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this._emitChars("ï¿½");
				break;
			case io.EOF:
				this._emitEOFToken();
				break;
	...
	_stateTagName(e) {
		...
		switch (e) {
			...
			case io.GREATER_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), t.tagName += "ï¿½";
				break;
			case io.EOF:
	...
	_stateScriptDataEscapedDash(e) {
		switch (e) {
			...
			case io.LESS_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this.state = Ko.SCRIPT_DATA_ESCAPED, this._emitChars("ï¿½");
				break;
			case io.EOF:
				this._err(Eo.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
				break;
	...
	_stateScriptDataDoubleEscapedDash(e) {
		switch (e) {
			...
			case io.LESS_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this.state = Ko.SCRIPT_DATA_DOUBLE_ESCAPED, this._emitChars("ï¿½");
				break;
			case io.EOF:
				this._err(Eo.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
				break;
	...
	_stateAttributeName(e) {
		switch (e) {
			...
			case io.LESS_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this.currentAttr.name += "ï¿½";
				break;
			default:
	...
	_stateAttributeValueDoubleQuoted(e) {
		switch (e) {
			...
			case io.AMPERSAND:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this.currentAttr.value += "ï¿½";
				break;
			case io.EOF:
				this._err(Eo.eofInTag), this._emitEOFToken();
				break;
	...
	_stateBogusComment(e) {
		...
		switch (e) {
			...
			case io.EOF:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), t.data += "ï¿½";
				break;
			default:
	...
	_stateBeforeDoctypeName(e) {
		if (Wo(e)) this._createDoctypeToken(String.fromCharCode(Jo(e))), this.state = Ko.DOCTYPE_NAME;
			...
			case io.FORM_FEED:
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), this._createDoctypeToken("ï¿½"), this.state = Ko.DOCTYPE_NAME;
				break;
			case io.GREATER_THAN_SIGN: {
	...
	_stateDoctypeName(e) {
		...
		switch (e) {
			...
			case io.GREATER_THAN_SIGN:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), t.name += "ï¿½";
				break;
			case io.EOF:
	...
	_stateDoctypePublicIdentifierDoubleQuoted(e) {
		...
		switch (e) {
			case io.QUOTATION_MARK:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), t.publicId += "ï¿½";
				break;
			case io.GREATER_THAN_SIGN:
	...
	_stateDoctypeSystemIdentifierDoubleQuoted(e) {
		...
		switch (e) {
			case io.QUOTATION_MARK:
				...
				break;
			case io.NULL:
				this._err(Eo.unexpectedNullCharacter), t.systemId += "ï¿½";
				break;
			case io.GREATER_THAN_SIGN:
...
class wc {
	...
	onNullCharacter(e) {
		if (this.skipNextNewLine = !1, this.tokenizer.inForeignNode) ! function(e, t) {
			t.chars = "ï¿½", e._insertCharacters(t)
		}(this, e);
		else switch (this.insertionMode) {
			case Rc.INITIAL:
				Vc(this, e);
